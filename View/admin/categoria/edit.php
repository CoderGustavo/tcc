      ...
      <div class="container-fluid">
        <div class="row">
          <div class="d-flex justify-content-center align-items-center w-100" style="height: 100vh;">
            <form class="form-signin border p-4 shadow rounded" style="border-top: 5px solid #cda45e !important;" method="POST" action="<?= url("admin/editar/categoria") ?>">
              ...
              <h1 class="mb-5">Editar Categoria do Cardápio</h1>

              <input type="hidden" name="id" value="<?php echo $categoria->id?>">
              <label for="inputNome">Nome:</label>
              <input type="text" name="nome" id="inputNome" required="required" class="form-control mb-3 border-0 shadow" placeholder="Ex: Bebidas" value="<?php echo $categoria->nome?>"/>
