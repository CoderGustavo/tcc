                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle">
                        <p>
                          <a href="<?= url("admin/edit/categoria/$linha->id") ?>"><i class="far fa-edit text-warning rounded-pill p-2"></i></a>
                          <a href="#" data-toggle="modal" data-target="#deleteCategoria<?php echo $linha->id ?>"><i class="far fa-trash text-danger rounded-pill p-2"></i></a>
                        </p>
                      </td>
                      </tr>
