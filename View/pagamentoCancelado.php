...
<body>
    ...
    <div class="bolha bg-danger">
    </div>
    <div class="center-msg border border-danger">
        <div>
            <h1>Pagamento <strong>REJEITADO</strong></h1>
        </div>
        <div>
            <h3>Pedido nº <span class="text-danger"><?php echo $idpedido?></span></h3>
            <p>Seu pedido teve o pagamento Rejeitado, então cancelamos seu pedido!</p>
            <a href="<?= url("delivery") ?>" class="btn btn-danger rounded-pill">REALIZAR OUTRO PEDIDO</a>
        </div>
    </div>
