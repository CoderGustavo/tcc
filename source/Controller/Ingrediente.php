...
class Ingrediente
{
    ...
    public function read($data){
        ...
        echo $this->view->render("admin/ingredientes/listar", ["ingredientes" => $ingredientes, "usuario" => $usuario]);
    }

    public function add($data){
        session_start();
        $usuario = $_SESSION["usuario"];
        echo $this->view->render("admin/ingredientes/cadastrar", ["usuario" => $usuario]);
    }
    ...
    public function show($data){
        ...
        echo $this->view->render("admin/ingredientes/edit", ["ingrediente" => $ingrediente, "usuario" => $usuario]);
    }
