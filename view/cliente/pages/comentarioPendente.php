                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php } else { ?>
                        ...
                        <a href="../avaliacao-excluir.php?id=<?php echo $linha['id'] ?>"><i class="taman fas fa-times text-light text-center bg-danger rounded-circle border border-dark p-1"></i></a>
                      <?php } ?>
                      </td>
                    </tr>
                    <?php endforeach ?>
