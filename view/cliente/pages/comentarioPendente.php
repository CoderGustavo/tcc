...
$lista = $comentario->listarPendentes();
session_start();
...
<?php include("layout/modalAprovarPendente.php"); ?>
<?php include("layout/modalExcluirPendente.php"); ?>
<div class="wrapper">
  <!-- Navbar -->
  <?php 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Todos os comentários pendentes</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Tela Inicial</a></li>
              <li class="breadcrumb-item active">Comentários pendentes</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Todos os comentários pendentes</h3>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php } else { ?>
                        ...
                        <a href="../comentario-excluir.php?id=<?php echo $linha['id'] ?>"><i class="taman fas fa-times text-light text-center bg-danger rounded-circle border border-dark p-1"></i></a>
                      <?php } ?>
                      </td>
                    </tr>
                    <?php endforeach ?>
