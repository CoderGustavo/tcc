...
<head>
  ...
  <title>Todos os Pedidos Em Entregues</title>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Todos os pedidos entregues</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Administração</a></li>
              <li class="breadcrumb-item active">Todos os pedidos entregues</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-md-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Todos os pedidos entregues</h3>
              </div>
              <!-- /.card-header -->
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?php echo $linha['entrega'] ?></td>
                        <td class="badge badge-pill bg-success p-2"> <?php echo $linha['status'] ?> </td>
                      <td>
