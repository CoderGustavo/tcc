...
<html lang="pt-br">
  ...
  <body class="text-center">
    <form class="form-signin" method="POST" action="../controller/usuario/logar-usuario.php">
        <?php
          session_start();
      ...
      <a href="cadastrar.php" class="btn text-light">Ainda não possue uma conta? Crie aqui!</a>
      <br>
